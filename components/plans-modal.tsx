    ...
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="sm:max-w-[800px] p-0 overflow-hidden">
        <div className="p-6 sm:p-8 bg-muted/40 border-b">
          <DialogHeader>
            <DialogTitle className="text-2xl text-center">Choose Your Vault Plan</DialogTitle>
          ...
          <div className="p-6 sm:p-8 flex flex-col h-full bg-background">
            ...
            <ul className="space-y-3 mb-8 flex-1">
              ...
              <li className="flex items-start gap-3">
                ...
                <span className="text-sm">Secure: no one can access your passwords but you</span>
              </li>
              <li className="flex items-start gap-3">
              ...
              <li className="flex items-start gap-3 text-muted-foreground">
                <span className="text-sm italic">Note: If you clear your browser storage, cache, or update, your data will be gone!</span>
              </li>
            </ul>
          ...
          <div className="p-6 sm:p-8 flex flex-col h-full bg-primary/5 relative">
            ...
            <ul className="space-y-3 mb-8 flex-1">
              <li className="flex items-start gap-3">
                ...
                <span className="text-sm font-medium">Bring your own database (Supabase)</span>
              </li>
              <li className="flex items-start gap-3">
                <Shield className="h-5 w-5 text-primary shrink-0 mt-0.5" />
              ...
              <li className="flex items-start gap-3">
                <Lock className="h-5 w-5 text-primary shrink-0 mt-0.5" />
                <span className="text-sm">DB credentials saved in your Chrome storage (none linked to your account)</span>
              </li>
              <li className="flex items-start gap-3 text-muted-foreground">
                <span className="text-sm italic">Note: If you clear browser storage, you just need to re-authenticate your Supabase. Your data is safe!</span>
              </li>
            </ul>
            <Button 
              className="w-full" 
